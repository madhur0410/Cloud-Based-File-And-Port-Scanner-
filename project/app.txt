...
#                if 'text' not in file_type:  # We only want to scan non-text files
                message = scan_file(filepath)
#                else:
#                    message = 'File is text-based. No virus scanning done.'
...
#    ports = scan_ports(ip)
#    return render_template('ports.html', ip=ip, ports=ports)
